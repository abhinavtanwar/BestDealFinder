$(document).ready(function () {
  ...
  $("#search_bar").keypress(function (e) {
    var key = e.which;
    if (key == 13) {
      // user presses the enter key code in the search bar
      e.preventDefault();
      get_data();
  ...
  function get_data() {
    ...
    if (form_data.length > 0) {
      ...
      function send_data(item) {
        ...
        function create_product_details_div(
          item_number,
          product_data,
          curr_checkbox_name
        ) {
          ...
          $(parent).append(
            $("<div>").prop({
              innerHTML:
                "<div class='results_products_item_subtitle'>Product Name: </div>" +
          ...
          $(parent).append(
            $("<div>").prop({
              innerHTML:
                "<div class='results_products_item_subtitle'>Product Rating: </div>" +
          ...
          // Product Price
          let text =
            "<div class='results_products_item_subtitle'>Product Price: </div>";
          ...
          $(parent).append(
            $("<a>").prop({
              innerHTML:
                "<div class='results_products_item_subtitle'>Product Link: </div>" +
      ...
      function create_csv(products_data) {
        ...
        $("#csv_download_button").on("click", function (e) {
          ...
          a.href =
            "data:attachment/csv;charset=utf-8,%EF%BB%BF" + escape(csvstring);
          a.target = "_blank";
          a.download = filename;
